...
#define TRAVEL_CCM_LOG_CRITICAL(iToBeLogged) \
  TRAVEL-CCM_LOG_CORE (TRAVEL_CCM::LOG::CRITICAL, iToBeLogged)

#define TRAVEL_CCM_LOG_ERROR(iToBeLogged) \
  TRAVEL-CCM_LOG_CORE (TRAVEL_CCM::LOG::ERROR, iToBeLogged)

#define TRAVEL_CCM_LOG_NOTIFICATION(iToBeLogged) \
  TRAVEL-CCM_LOG_CORE (TRAVEL_CCM::LOG::NOTIFICATION, iToBeLogged)

#define TRAVEL_CCM_LOG_WARNING(iToBeLogged) \
  TRAVEL-CCM_LOG_CORE (TRAVEL_CCM::LOG::WARNING, iToBeLogged)

#define TRAVEL_CCM_LOG_DEBUG(iToBeLogged) \
  TRAVEL-CCM_LOG_CORE (TRAVEL_CCM::LOG::DEBUG, iToBeLogged)

#define TRAVEL_CCM_LOG_VERBOSE(iToBeLogged) \
  TRAVEL-CCM_LOG_CORE (TRAVEL_CCM::LOG::VERBOSE, iToBeLogged)
// /////////// (END OF) LOG MACROS /////////////
